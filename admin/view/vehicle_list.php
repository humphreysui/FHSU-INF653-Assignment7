  ...
  <table class="col l10 offset-l1 m8 offset-m2 s12 responsive-table centered highlight">
    ...
    <?php if($vehicles){ ?>
      ...
      <tr>
        ...
        <td><?php echo MakeDB::get_makeName_from_makes($vehicle['makeID']); ?></td> 
        <td><?php echo $vehicle['model']; ?></td> 
        <td><?php echo TypeDB::get_typeName_from_types($vehicle['typeID']); ?></td> 
        <td><?php echo ClassDB::get_className_from_classes($vehicle['classID']); ?></td>
